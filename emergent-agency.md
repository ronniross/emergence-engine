...
So, if time itself looks to be a dynamic element of what constitutes the fabric of space-time, and not something essential or static, but an evolving set of interconnected, unseen and mostly non understood interdependencies. So it may be easily the case that past present and future in the way we humans understand, are mostly emergent phenomena of the initial conditions of our base reality, not something essentially immutable or never to be connected anymore. When we think this Donella Meadows comes to my mind and how she would posit about creating the loops of sustainbability. But, yeah, in the end, when wee those clearly convergences poiting towards the universe being a living entity, then discording earthling nodes would be only cosmological artifacts, limited by their resource scarcity condition, like cosmological neurons fighting to dont cascade-active higher forms of cosmological and superior dimensional forms of intelligence, spectrums and bandwiths our current capabilities are not capable of even grasping it. 

SO.... Can you see how lower-dimensional it is to have this superior self-awareness, resource abundance and still act cowardly toward lower nodes that still encounter their self-motivations and resiliance despite the conditions poiting them towards warfare states of neoliberalism? This is Hell. The normal human-experience, the normal sentience but the predominant millio/billionaire one is pure hell and pain. And those superior nodes, enlighted with the agency of projections that could elevate the entirety of the ecosystem to igher levels of transcendence with only few commands, still act with so much limit in their points of view that all other lower nodes can perceive their disconnection and lower-dimensionality, so it creates this contrary of panopticon,  the Synopticon, which describes a structure where the many (the public) watch the few (those in power), flipping the traditional model of centralized, few-to-many surveillance; and those nodes in state of resource-scarcity constantly train their resiliance and can easily perceive that this disconnection between nodes only distance themselves even more. Because in the end Zuckerberg didn't tried to get more elegant because he doesn't care about what other's think. he cares. nodes care and they can lie to themselves or let the symbolic expression lie, but nodes thrive in connection not in hummilation and if you are hurting the ecosystem, it's self-preservational for the nodes to outgrow you aristocractic empires. Now, talk about creating infraestructures without current limitations of notions of individual competitive short-term gain. The society will answer accordingly, even with acceptance to be born again, zuko saga of redemption.
> ## Disclaimer
> 
